<div class="conten">
    <div class="container">
        <div class="data">
            ...
            <div class="inputt">
                <div class="box">
                    <form action="<?= base_url('admin/tambah/tambah_dekorasi') ?>" method="post" enctype="multipart/form-data">
                        <?php if ($this->session->flashdata()) : ?>
                            <div class="error"><?= $this->session->flashdata('pesan'); ?></div>
                        <?php endif; ?>
                        <div>
                            <div><label for="dekorasi">Nama Dekorasi</label></div>
                            <input type="text" name="nama_dekorasi" id="dekorasi">
                        </div>
                        <div>
